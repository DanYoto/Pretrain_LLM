...
class RewardDataCollatorWithPadding:
    def __init__(
        self, tokenizer, padding, max_length, pad_to_multiple_of, return_tensors
    ):
    ...
    def __call__(self, data_samples):
        ...
        for data_sample in data_samples:
            merged_features.append(
                {
                    "input_ids": data_sample["input_ids_acc"],
                    "attention_mask": data_sample["attention_mask_acc"],
                }
            )
            merged_features.append(
                {
                    "input_ids": data_sample["input_ids_rej"],
                    "attention_mask": data_sample["attention_mask_rej"],
                }
            )
